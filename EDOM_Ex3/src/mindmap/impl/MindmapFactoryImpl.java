...
public class MindmapFactoryImpl extends EFactoryImpl implements MindmapFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case MindmapPackage.MODEL: return createModel();
			case MindmapPackage.VERSION: return createVersion();
			case MindmapPackage.REQUIREMENT: return createRequirement();
			case MindmapPackage.COMMENT: return createComment();
			case MindmapPackage.REQUIREMENT_GROUP: return createRequirementGroup();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case MindmapPackage.RESOLUTION:
