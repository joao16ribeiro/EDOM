...
/**
 * This is the item provider adapter for a {@link mindmap.Model} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MindmapPackage.Literals.MODEL__TITLE,
				 true,
				 false,
				 false,
	...
	protected void addRequirementgroupPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Model_requirementgroup_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Model_requirementgroup_feature", "_UI_Model_type"),
				 MindmapPackage.Literals.MODEL__REQUIREMENTGROUP,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Model.class)) {
			case MindmapPackage.MODEL__TITLE:
